...
# main moto of this example is just to setup a MAVLINK pipeline for Precison landing using IR on OpenMV
import math
import sensor
import struct
import time
...
# making a custom mavlink packet for POC
def send_landing_target_packet():
